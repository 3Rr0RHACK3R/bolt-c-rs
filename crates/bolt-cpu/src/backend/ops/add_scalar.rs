...
impl AddScalarKernel for f32 {
    fn add_scalar_kernel(
        view: CpuTensorView<'_, Self>,
        scalar: Self,
        allocator: &CpuAllocator<Self>,
    ) -> Result<TensorParts<CpuStorage<Self>>> {
        add_scalar(view, scalar, allocator)
    }
}

impl AddScalarKernel for f64 {
    fn add_scalar_kernel(
        view: CpuTensorView<'_, Self>,
        scalar: Self,
        allocator: &CpuAllocator<Self>,
